...
/**
 * A command-line utility for editing the 'config' file used by the Monitor.
 * This is a standalone application entry point.
 */
public class EditConfig {
    ...
    public static void main(String[] args) throws Exception {
        // This main method acts as the "composition root" for this tool.
        // It's acceptable to create a concrete IO instance here.
        // We use the interface for variable typing for good practice.
        IOInterface io = new IO();

        io.pln("PCHWRM_Client Config Editor" +
                "\nVersion : 1.0" +
            ...
            if (userInput.equalsIgnoreCase("N")) {
                ...
                if (checkNo(userInput)) {
                    if (Integer.parseInt(userInput) < 1024) {
                        // This check for linux seems out of place if the server
                        // can run on Windows, but retaining original logic.
                        io.pln("Must be > 1024 for non-root users!");
                    }
